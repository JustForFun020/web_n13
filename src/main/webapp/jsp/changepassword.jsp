...
<link rel="stylesheet" href="/BTLWEB_N13/css/signup.css" />
...
<body>
	<main class="dangky__baoboc">
		...
		<div class="dangky__form">
			<form action="/BTLWEB_N13/change" class="form" method="post">
				<div class="form__chu">
					<h1 style="color: rgb(196, 196, 196)">Đổi Mật Khẩu </h1>
				</div>
				...
				<div style="display: flex; flex-direction: column">
					...
					<div
						style="display: flex; flex-direction: column; margin-bottom: 20px">
						<label for="matkhaumoi">Mật Khẩu Mới</label> <input type="text"
							id="matkhaumoi" name="matkhaumoi" />
					</div>

					<div
						style="display: flex; flex-direction: column; margin-bottom: 20px">
						<label for="xacnhanmatkhau">Xác Nhận Mật Khẩu</label> <input
							type="text" id="xacnhanmatkhau" name="xacnhanmatkhau" />
					</div>
